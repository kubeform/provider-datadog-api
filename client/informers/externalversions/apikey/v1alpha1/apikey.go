...
import (
	...
	v1alpha1 "kubeform.dev/provider-datadog-api/client/listers/apikey/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ApikeyV1alpha1().ApiKeys(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ApikeyV1alpha1().ApiKeys(namespace).Watch(context.TODO(), options)
			},
		},
		&apikeyv1alpha1.ApiKey{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *apiKeyInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apikeyv1alpha1.ApiKey{}, f.defaultInformer)
}
