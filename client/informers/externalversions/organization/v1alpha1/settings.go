...
import (
	...
	v1alpha1 "kubeform.dev/provider-datadog-api/client/listers/organization/v1alpha1"
...
type SettingsInformer interface {
	...
	Lister() v1alpha1.SettingsLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.OrganizationV1alpha1().Settingses(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.OrganizationV1alpha1().Settingses(namespace).Watch(context.TODO(), options)
			},
		},
		&organizationv1alpha1.Settings{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *settingsInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&organizationv1alpha1.Settings{}, f.defaultInformer)
}

func (f *settingsInformer) Lister() v1alpha1.SettingsLister {
	return v1alpha1.NewSettingsLister(f.Informer().GetIndexer())
}
