...
type Interface interface {
	...
	// Jsons returns a JsonInformer.
	Jsons() JsonInformer
	// Lists returns a ListInformer.
	Lists() ListInformer
}
...
// Jsons returns a JsonInformer.
func (v *version) Jsons() JsonInformer {
	return &jsonInformer{factory: v.factory, namespace: v.namespace, tweakListOptions: v.tweakListOptions}
}

// Lists returns a ListInformer.
func (v *version) Lists() ListInformer {
	return &listInformer{factory: v.factory, namespace: v.namespace, tweakListOptions: v.tweakListOptions}
}
