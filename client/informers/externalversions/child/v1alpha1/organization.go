...
import (
	...
	v1alpha1 "kubeform.dev/provider-datadog-api/client/listers/child/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ChildV1alpha1().Organizations(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ChildV1alpha1().Organizations(namespace).Watch(context.TODO(), options)
			},
		},
		&childv1alpha1.Organization{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *organizationInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&childv1alpha1.Organization{}, f.defaultInformer)
}
