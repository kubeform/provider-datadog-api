	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.MonitorV1alpha1().Jsons(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.MonitorV1alpha1().Jsons(namespace).Watch(context.TODO(), options)
			},
		},
		&monitorv1alpha1.Json{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *jsonInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&monitorv1alpha1.Json{}, f.defaultInformer)
}
