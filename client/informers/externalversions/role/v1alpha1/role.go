...
import (
	...
	v1alpha1 "kubeform.dev/provider-datadog-api/client/listers/role/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.RoleV1alpha1().Roles(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.RoleV1alpha1().Roles(namespace).Watch(context.TODO(), options)
			},
		},
		&rolev1alpha1.Role{},
		resyncPeriod,
...
func (f *roleInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&rolev1alpha1.Role{}, f.defaultInformer)
}
