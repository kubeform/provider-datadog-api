	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.LogsV1alpha1().Metrics(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.LogsV1alpha1().Metrics(namespace).Watch(context.TODO(), options)
			},
		},
		&logsv1alpha1.Metric{},
		resyncPeriod,
...
func (f *metricInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&logsv1alpha1.Metric{}, f.defaultInformer)
}
