...
type Interface interface {
	// CustomVariables returns a CustomVariableInformer.
	CustomVariables() CustomVariableInformer
...
// CustomVariables returns a CustomVariableInformer.
func (v *version) CustomVariables() CustomVariableInformer {
	return &customVariableInformer{factory: v.factory, namespace: v.namespace, tweakListOptions: v.tweakListOptions}
}
