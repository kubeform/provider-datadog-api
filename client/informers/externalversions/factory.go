...
func (f *sharedInformerFactory) Downtime() downtime.Interface {
	return downtime.New(f, f.namespace, f.tweakListOptions)
}
...
func (f *sharedInformerFactory) Metric() metric.Interface {
	return metric.New(f, f.namespace, f.tweakListOptions)
}
