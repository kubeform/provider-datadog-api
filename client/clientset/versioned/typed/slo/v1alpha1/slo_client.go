...
// SloV1alpha1Client is used to interact with features provided by the slo.datadog.kubeform.com group.
type SloV1alpha1Client struct {
	restClient rest.Interface
}

func (c *SloV1alpha1Client) Corrections(namespace string) CorrectionInterface {
	return newCorrections(c, namespace)
}
