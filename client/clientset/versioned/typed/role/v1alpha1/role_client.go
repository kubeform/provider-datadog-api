...
// RoleV1alpha1Client is used to interact with features provided by the role.datadog.kubeform.com group.
type RoleV1alpha1Client struct {
	restClient rest.Interface
}

func (c *RoleV1alpha1Client) Roles(namespace string) RoleInterface {
