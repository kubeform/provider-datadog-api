...
type FakeOrganizations struct {
	Fake *FakeChildV1alpha1
	ns   string
}

var organizationsResource = schema.GroupVersionResource{Group: "child.datadog.kubeform.com", Version: "v1alpha1", Resource: "organizations"}

var organizationsKind = schema.GroupVersionKind{Group: "child.datadog.kubeform.com", Version: "v1alpha1", Kind: "Organization"}
