...
type WebhookV1alpha1Interface interface {
	...
	CustomVariablesGetter
	WebhooksGetter
}

// WebhookV1alpha1Client is used to interact with features provided by the webhook.datadog.kubeform.com group.
type WebhookV1alpha1Client struct {
	restClient rest.Interface
}

func (c *WebhookV1alpha1Client) CustomVariables(namespace string) CustomVariableInterface {
	return newCustomVariables(c, namespace)
}

func (c *WebhookV1alpha1Client) Webhooks(namespace string) WebhookInterface {
