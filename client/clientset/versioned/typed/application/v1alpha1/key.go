...
import (
	...
	v1alpha1 "kubeform.dev/provider-datadog-api/apis/application/v1alpha1"
...
func newKeys(c *ApplicationV1alpha1Client, namespace string) *keys {
	return &keys{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *keys) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Key, err error) {
	result = &v1alpha1.Key{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("keys").
...
func (c *keys) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.KeyList, err error) {
...
func (c *keys) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *keys) Create(ctx context.Context, key *v1alpha1.Key, opts v1.CreateOptions) (result *v1alpha1.Key, err error) {
	result = &v1alpha1.Key{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("keys").
...
func (c *keys) Update(ctx context.Context, key *v1alpha1.Key, opts v1.UpdateOptions) (result *v1alpha1.Key, err error) {
	result = &v1alpha1.Key{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("keys").
...
func (c *keys) UpdateStatus(ctx context.Context, key *v1alpha1.Key, opts v1.UpdateOptions) (result *v1alpha1.Key, err error) {
	result = &v1alpha1.Key{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("keys").
...
func (c *keys) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *keys) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *keys) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Key, err error) {
	result = &v1alpha1.Key{}
