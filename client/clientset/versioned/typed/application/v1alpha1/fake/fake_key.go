...
var keysResource = schema.GroupVersionResource{Group: "application.datadog.kubeform.com", Version: "v1alpha1", Resource: "keys"}

var keysKind = schema.GroupVersionKind{Group: "application.datadog.kubeform.com", Version: "v1alpha1", Kind: "Key"}
