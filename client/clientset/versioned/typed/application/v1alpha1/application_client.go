...
// ApplicationV1alpha1Client is used to interact with features provided by the application.datadog.kubeform.com group.
type ApplicationV1alpha1Client struct {
	restClient rest.Interface
}

func (c *ApplicationV1alpha1Client) Keys(namespace string) KeyInterface {
