...
var testsResource = schema.GroupVersionResource{Group: "synthetics.datadog.kubeform.com", Version: "v1alpha1", Resource: "tests"}

var testsKind = schema.GroupVersionKind{Group: "synthetics.datadog.kubeform.com", Version: "v1alpha1", Kind: "Test"}
