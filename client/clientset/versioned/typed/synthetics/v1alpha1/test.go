...
func newTests(c *SyntheticsV1alpha1Client, namespace string) *tests {
	return &tests{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *tests) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Test, err error) {
...
func (c *tests) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.TestList, err error) {
...
func (c *tests) Create(ctx context.Context, test *v1alpha1.Test, opts v1.CreateOptions) (result *v1alpha1.Test, err error) {
	result = &v1alpha1.Test{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("tests").
...
func (c *tests) Update(ctx context.Context, test *v1alpha1.Test, opts v1.UpdateOptions) (result *v1alpha1.Test, err error) {
	result = &v1alpha1.Test{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("tests").
...
func (c *tests) UpdateStatus(ctx context.Context, test *v1alpha1.Test, opts v1.UpdateOptions) (result *v1alpha1.Test, err error) {
	result = &v1alpha1.Test{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("tests").
...
func (c *tests) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *tests) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *tests) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Test, err error) {
	result = &v1alpha1.Test{}
