...
// GcpsGetter has a method to return a GcpInterface.
...
// gcps implements GcpInterface
type gcps struct {
	client rest.Interface
	ns     string
}

// newGcps returns a Gcps
func newGcps(c *IntegrationV1alpha1Client, namespace string) *gcps {
	return &gcps{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *gcps) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Gcp, err error) {
	result = &v1alpha1.Gcp{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("gcps").
...
func (c *gcps) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.GcpList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.GcpList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("gcps").
...
func (c *gcps) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *gcps) Create(ctx context.Context, gcp *v1alpha1.Gcp, opts v1.CreateOptions) (result *v1alpha1.Gcp, err error) {
	result = &v1alpha1.Gcp{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("gcps").
...
func (c *gcps) Update(ctx context.Context, gcp *v1alpha1.Gcp, opts v1.UpdateOptions) (result *v1alpha1.Gcp, err error) {
	result = &v1alpha1.Gcp{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("gcps").
...
func (c *gcps) UpdateStatus(ctx context.Context, gcp *v1alpha1.Gcp, opts v1.UpdateOptions) (result *v1alpha1.Gcp, err error) {
	result = &v1alpha1.Gcp{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("gcps").
...
func (c *gcps) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *gcps) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *gcps) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Gcp, err error) {
	result = &v1alpha1.Gcp{}
