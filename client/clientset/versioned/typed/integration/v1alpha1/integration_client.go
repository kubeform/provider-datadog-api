...
type IntegrationV1alpha1Interface interface {
	RESTClient() rest.Interface
	AwsesGetter
	AwsLambdaArnsGetter
	AwsLogCollectionsGetter
	AwsTagFiltersGetter
	AzuresGetter
	GcpsGetter
	PagerdutiesGetter
	PagerdutyServiceObjectsGetter
	SlackChannelsGetter
}
...
func NewForConfig(c *rest.Config) (*IntegrationV1alpha1Client, error) {
	...
	return &IntegrationV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new IntegrationV1alpha1Client for the given config and
...
func New(c rest.Interface) *IntegrationV1alpha1Client {
	return &IntegrationV1alpha1Client{c}
}
