...
func newAzures(c *IntegrationV1alpha1Client, namespace string) *azures {
	return &azures{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *azures) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Azure, err error) {
...
func (c *azures) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.AzureList, err error) {
...
func (c *azures) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *azures) Create(ctx context.Context, azure *v1alpha1.Azure, opts v1.CreateOptions) (result *v1alpha1.Azure, err error) {
	result = &v1alpha1.Azure{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("azures").
...
func (c *azures) Update(ctx context.Context, azure *v1alpha1.Azure, opts v1.UpdateOptions) (result *v1alpha1.Azure, err error) {
	result = &v1alpha1.Azure{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("azures").
...
func (c *azures) UpdateStatus(ctx context.Context, azure *v1alpha1.Azure, opts v1.UpdateOptions) (result *v1alpha1.Azure, err error) {
	result = &v1alpha1.Azure{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("azures").
...
func (c *azures) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *azures) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *azures) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Azure, err error) {
	result = &v1alpha1.Azure{}
