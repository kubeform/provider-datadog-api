...
// DashboardV1alpha1Client is used to interact with features provided by the dashboard.datadog.kubeform.com group.
...
func (c *DashboardV1alpha1Client) Jsons(namespace string) JsonInterface {
	return newJsons(c, namespace)
}

func (c *DashboardV1alpha1Client) Lists(namespace string) ListInterface {
	return newLists(c, namespace)
}
